...
const TOPICS_BY_COMPLEXITY = {
  basic: ['基因', '基因型与表型', '中心法则', '等位基因', '纯合子与杂合子', '孟德尔第一定律', '孟德尔第二定律', '密码子', '转录', '翻译', 'DNA复制', 'PCR技术'],
  intermediate: ['伴性遗传', 'X连锁遗传', '连锁互换', '显性与隐性遗传', '测交', '共显性', '不完全显性', '转录与翻译', '基因突变', '核糖体', '乳糖操纵子', '复制叉', '前导链', '后随链', 'DNA聚合酶', '启动子', '剪接', '基因调控', 'DNA双螺旋结构', '染色体', '有丝分裂', '染色体结构', '染色体畸变', '三体', '哈代-温伯格定律', '遗传漂变', '自然选择', 'DNA甲基化', '组蛋白修饰', 'RNA干扰', 'CRISPR', '基因工程'],
  advanced: ['DNA修复', '表观遗传记忆', '基因表达调控', '染色体结构畸变', '非整倍体', '核型', '多倍体', '罗伯逊易位', '联会', '同源重组', '染色体组型', '瓶颈效应', '奠基者效应', '基因流', '突变', '染色质重塑', '非编码RNA', '基因组印记', '测序技术', '基因克隆', '载体系统'],
};
