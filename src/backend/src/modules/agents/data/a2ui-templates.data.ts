...
export const A2UI_TEMPLATES: A2UITemplate[] = [
  ...
  // 遗传路径模板
  {
              ...
              individuals: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    carrier: { type: 'boolean', description: '是否携带者' },
                    parents: { type: 'array', items: { type: 'string' }, description: '父母ID' }
                  },
    ...
    defaultValues: {
      generations: [
        {
          generation: 1,
          individuals: [
            { id: 'I-1', sex: 'male', genotype: 'XY', phenotype: '正常', affected: false },
            { id: 'I-2', sex: 'female', genotype: 'X^AX^a', phenotype: '携带者', affected: false, carrier: true }
          ]
        },
        {
          generation: 2,
          individuals: [
            { id: 'II-1', sex: 'female', genotype: 'X^AX^A', phenotype: '正常', affected: false, parents: ['I-1', 'I-2'] },
            { id: 'II-2', sex: 'female', genotype: 'X^AX^a', phenotype: '携带者', affected: false, carrier: true, parents: ['I-1', 'I-2'] },
            { id: 'II-3', sex: 'male', genotype: 'X^AY', phenotype: '正常', affected: false, parents: ['I-1', 'I-2'] },
            { id: 'II-4', sex: 'male', genotype: 'X^aY', phenotype: '患病', affected: true, parents: ['I-1', 'I-2'] }
          ]
        }
      ],
      inheritance: {
      ...
      explanation: 'X连锁隐性遗传的典型系谱：女性携带者与正常男性婚配，后代中男性有50%概率患病，女性有50%概率成为携带者。'
    },
    a2uiTemplate: {
      type: 'card',
      id: 'viz_inheritance_path',
      children: [
        {
          type: 'ahatutor-inheritance-path',
          id: 'inheritance_path_component',
          properties: {
